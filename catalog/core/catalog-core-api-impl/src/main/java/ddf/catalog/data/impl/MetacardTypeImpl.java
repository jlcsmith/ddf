...
public class MetacardTypeImpl implements MetacardType {
    ...
    /**
     * Creates a {@code MetacardTypeImpl} with the provided {@link MetacardType}, set of
     * additional {@linkplain AttributeDescriptor AttributeDescriptors}, and name.
     * <p>
     ...
     */
    public MetacardTypeImpl(MetacardType metacardType,
            Set<AttributeDescriptor> additionalDescriptors, String name) {
